        ...
        <div className="flex min-h-[76vh] flex-col items-center justify-center py-6">
            <form onSubmit={handleSubmit} className="w-full max-w-md rounded-[1.8rem] border border-gray-200/80 bg-white/85 p-7 shadow-[0_22px_50px_rgba(15,23,42,0.10)] backdrop-blur-xl transition-colors duration-300 sm:p-9 dark:border-[#1F1F22] dark:bg-[#121214]/82 dark:shadow-[0_26px_58px_rgba(0,0,0,0.45)]">
                <div className="mb-7 text-center">
                    <span className="inline-flex rounded-full border border-gray-200 bg-gray-50 px-4 py-1.5 text-[0.7rem] font-medium uppercase tracking-[0.2em] text-gray-600 dark:border-[#2A2A30] dark:bg-white/3 dark:text-gray-400">Create Account</span>
                    <h2 className="mt-4 text-3xl font-semibold tracking-tight text-gray-900 dark:text-gray-100">Sign Up</h2>
                    <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">Join HackDekh and start managing your hackathon journey.</p>
                </div>

                {error && <div className="mb-4 rounded-xl border border-red-400/25 bg-red-500/10 px-4 py-3 text-sm text-red-300">{error}</div>}
                <div className="mb-4">
                    <label className="mb-1.5 block text-sm font-medium text-gray-600 dark:text-gray-400">Username</label>
                    <input
                        type="text"
